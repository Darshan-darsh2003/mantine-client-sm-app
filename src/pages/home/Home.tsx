...
import { ActionIcon, Autocomplete, Button, Center, Divider, Grid, Group, Paper, ScrollArea, Title, Tooltip, rem } from "@mantine/core";
import { IconCirclePlus, IconPhotoPlus, IconSearch, IconSquarePlus } from "@tabler/icons-react";
...
const Home = () => {
 ...
 <Grid>
     ...
     <Title py={5} order={3}>Stories</Title>
     <Group>
      ...
      {/* <ActionIcon
                ...
                size="lg"
              >
                <IconCirclePlus stroke={1} size={30} />
              </ActionIcon> */}
<Button variant="default" leftSection={
  <IconSquarePlus stroke={1} size={25} />
}>
  Add Story
</Button>
      </Tooltip>
      ...
      <Divider />
        ...
        <Grid.Col span={12}>
          ...
          <Tooltip label="Add Story">
<Button variant="default" leftSection={
  <IconPhotoPlus stroke={1} size={25} />
}>
  New Post
</Button>
      </Tooltip>
